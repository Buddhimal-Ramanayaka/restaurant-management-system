...
EXAMINER = [
    ...
    ('7',  'Formatting issues', 'blocked',
     'Document passes every measurable check against the IT5106 template: margins, font sizes, figure sizing, caption pairing, 111 front-matter page numbers all verified against the rendered PDF. Need either the examiner’s specifics or a pass-marked report to infer the house standard.'),
...
OTHER = [
    ...
    ('Confirm two figure sizes', 'yours', 'Figure 3.3 came back at 5.56 × 8.67 in and Figure 3.6 at 3.64 × 8.91 in — 63% of the column. Those looked like manual resizes from your final pass and both were reset to full width. Say if either was deliberate.'),
    ('A pass-marked sample report', 'yours', 'Still the one thing that would unblock item 7. Any report that passed IT5106 would let me infer the house formatting standard.'),
